...
export interface ApiAboutAbout extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TextP1: Schema.Attribute.RichText & Schema.Attribute.Required;
    textP2: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDocDoc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    doc_name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPerformancePerformance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cast: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creators: Schema.Attribute.RichText;
...
export interface ApiRepertoireMonthRepertoireMonth
  extends Struct.CollectionTypeSchema {
  collectionName: 'repertoire_months';
  info: {
    displayName: 'repertoire-month';
    pluralName: 'repertoire-months';
    singularName: 'repertoire-month';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::repertoire-month.repertoire-month'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTouringTouring extends Struct.SingleTypeSchema {
  collectionName: 'tourings';
  info: {
    displayName: 'Touring';
    pluralName: 'tourings';
    singularName: 'touring';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Touring: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    users: Schema.Attribute.Relation<'manyToMany', 'api::review.review'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::repertoire-month.repertoire-month': ApiRepertoireMonthRepertoireMonth;
      'api::review.review': ApiReviewReview;
      'api::service.service': ApiServiceService;
      'api::slider.slider': ApiSliderSlider;
      'api::team.team': ApiTeamTeam;
      'api::touring.touring': ApiTouringTouring;
